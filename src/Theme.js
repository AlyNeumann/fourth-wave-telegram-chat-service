...
function updateLightTheme(theme) {
    ...
    style.setProperty('--text-secondary', '#707977');
    ...
    style.setProperty('--color-hover', '#70797714');
    ...
    style.setProperty('--header-subtle-color', '#707977');

    style.setProperty('--badge-unmuted', '#4dcdc0');
    ...
    style.setProperty('--online-indicator', '#0ac6c0');
    ...
    style.setProperty('--border', '#dae0e0');
    ...
    style.setProperty('--dialog-subtle-color', '#707977');
    style.setProperty('--dialog-meta-color', '#dae0e0');
    style.setProperty('--dialog-meta-read-color', '#4eaea9');

    style.setProperty('--media-in-tile-background', theme.palette.primary.main);
    style.setProperty('--media-out-tile-background', '#4eaea1');
    ...
    style.setProperty('--message-in-subtle-color', '#707977');
    style.setProperty('--message-in-meta-color', '#8d9c97');
    ...
    style.setProperty('--message-out-link', '#4eaea1');
    style.setProperty('--message-out-author', '#4eaea1');
    style.setProperty('--message-out-background', '#defff1');
    style.setProperty('--message-out-color', '#000000');
    style.setProperty('--message-out-subtle-color', '#4eaea1');
    style.setProperty('--message-out-meta-color', '#4eaea1');
    style.setProperty('--message-out-reply-title', '#4eaea1');
    style.setProperty('--message-out-reply-border', '#4eaea1');
    style.setProperty('--message-out-control', '#4eaea1');
    style.setProperty('--message-out-control-hover', '#4eaea1' + '22');
    style.setProperty('--message-out-control-border', '#4eaea1' + '77');
    style.setProperty('--message-out-control-border-hover', '#4eaea1');
}
...
function withTheme(WrappedComponent) {
    class ThemeWrapper extends React.Component {
        constructor(props) {
            ...
            let { type, primary } = { type: 'light', primary: { main: '#50e9d7' } };
            try {
