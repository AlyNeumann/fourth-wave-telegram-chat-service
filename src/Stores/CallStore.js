...
class CallStore extends EventEmitter {
    ...
    onUpdate = async update => {
        switch (update['@type']) {
            ...
            case 'updateGroupCall': {
                ...
                this.set(group_call);
                console.log('this from updateGroupCall')
                console.log(this)
    ...
    async updateGroupCallParticipants(groupCallId) {
        ...
        const { currentGroupCall } = this;
        console.log('this from updateGroupCallParticipants')
        console.log(this)
    ...
    async startGroupCall(chatId) {
        ...
        console.log('this from startGroupCallParticipants')
        console.log(this)
    ...
    async startGroupCallInternal(chatId) {
        ...
        console.log('this from startGroupCallInternal')
        console.log(this)
        console.log(chatId)
